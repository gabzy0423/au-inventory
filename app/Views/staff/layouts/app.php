...
<head>
    ...
    <title><?= $title ?? 'Staff' ?> | AU Inventory</title>
    <!-- Tailwind CDN for premium styling -->
    ...
    <style>
        ...
        .sidebar-staff { background: linear-gradient(180deg, #0f172a 0%, #1e1b4b 100%); }
...
<body class="min-h-screen" x-data="{ isSidebarOpen: false }" @keydown.escape="isSidebarOpen = false">
    <div class="flex h-screen overflow-hidden relative">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <!-- Page Content -->
            <main class="flex-1 overflow-x-hidden overflow-y-auto px-8 py-8">
    ...
    <div x-data="{ show: true }" 
         ...
         class="fixed bottom-8 right-8 z-[200] w-full max-w-md px-6">
        <div class="bg-rose-600 text-white p-5 rounded-[2.5rem] shadow-2xl shadow-rose-600/40 flex items-center gap-5 border border-rose-500/50 backdrop-blur-xl">
            ...
            <div class="flex-1">
                <h4 class="font-black text-[10px] uppercase tracking-[0.2em] opacity-80 leading-none italic">Security Alert</h4>
