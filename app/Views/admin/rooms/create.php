...
<div class="max-w-5xl mx-auto" x-data="{
    createData: { name: '', description: '', color: 'indigo' }
}">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            ...
            <h1 class="text-4xl font-black text-slate-900 tracking-tight italic">Register New Room</h1>
            <p class="text-slate-500 font-medium mt-1">Define a new physical space or facility for tracking asset distribution.</p>
        </div>
    ...
    <!-- Form Content -->
    <form id="createForm" action="<?= $base_url ?>/admin/rooms" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white p-8 md:p-10 rounded-[3rem] shadow-sm border border-slate-100 relative overflow-hidden group">
                ...
                <div class="flex items-center gap-3 mb-8 relative z-10">
                    ...
                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600">Room Identity</h3>
                </div>

                <div class="space-y-6 relative z-10">
                    <div class="space-y-4">
                        <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1">
                            Room Name / Number <span class="text-rose-500">*</span>
                        </label>
                        <input type="text" name="name" x-model="createData.name" required
                            placeholder="e.g. Computer Lab 5, Office 201"
                    ...
                    <div class="space-y-4">
                        ...
                        <textarea name="description" x-model="createData.description" rows="4"
                            placeholder="Briefly describe the room's location or purpose..."
                            class="w-full px-8 py-6 bg-slate-50/50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 focus:bg-white outline-none font-medium text-slate-700 transition-all placeholder-slate-300"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-slate-50/50 border-2 border-slate-100/50 rounded-2xl flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-slate-500 leading-relaxed font-medium">
                        Rooms serve as the primary location nodes for inventory tracking. Ensure naming conventions follow the building's physical signage for accurate audits.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="mt-8 p-4 bg-indigo-50/30 border border-indigo-100 rounded-2xl">
                        <p class="text-[9px] font-bold text-indigo-600 uppercase tracking-tight text-center leading-relaxed">
                            This color will represent the room in status indicators and maps.
                        </p>
                    </div>
                </div>
            </div>
