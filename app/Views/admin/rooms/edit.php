...
<div class="max-w-5xl mx-auto" x-data="{
    editData: <?= htmlspecialchars(json_encode($room), ENT_QUOTES, 'UTF-8') ?>
}">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            ...
            <h1 class="text-4xl font-black text-slate-900 tracking-tight italic">Update Room</h1>
            <p class="text-slate-500 font-medium mt-1">Modify the location parameters for "<?= htmlspecialchars($room['name']) ?>".</p>
        </div>
    ...
    <!-- Form Content -->
    <form id="editForm" action="<?= $base_url ?>/admin/rooms/update/<?= $room['id'] ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white p-8 md:p-10 rounded-[3rem] shadow-sm border border-slate-100 relative overflow-hidden group">
                ...
                <div class="flex items-center gap-3 mb-8 relative z-10">
                    ...
                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-amber-600">Room Identity</h3>
                </div>
                ...
                <div class="space-y-6 relative z-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <textarea name="description" x-model="editData.description" rows="4"
                            ...
                            class="w-full px-8 py-6 bg-slate-50/50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-amber-500/10 focus:border-amber-600 focus:bg-white outline-none font-medium text-slate-700 transition-all placeholder-slate-300"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-amber-50/30 border-2 border-amber-100/50 rounded-2xl flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-amber-600/80 leading-relaxed font-medium">
                        Modifying the room name will automatically update the location for all assigned assets to maintain inventory integrity.
                    </p>
                </div>
            </div>
        </div>
