...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-1 space-y-6">
            <div class="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col items-center text-center">
                <div class="relative group">
                    <div class="w-32 h-32 rounded-full overflow-hidden bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white text-4xl font-black shadow-2xl shadow-indigo-200">
        ...
        <div class="md:col-span-2">
            <form action="<?= $base_url ?>/admin/profile/update" method="POST" enctype="multipart/form-data" class="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm space-y-8">
                <div class="space-y-6">
                    <h3 class="text-sm font-black text-slate-900 uppercase tracking-[0.2em] border-l-4 border-indigo-600 pl-4 mb-8">Personal Identification</h3>
                    
                    <div class="grid grid-cols-1 gap-6">
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Full Name</label>
                            <input type="text" name="name" value="<?= htmlspecialchars($user['name']) ?>" required
                                class="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none font-bold text-slate-800 transition-all placeholder:text-slate-300">
                        </div>
                ...
                <div class="space-y-6 pt-4">
                    <h3 class="text-sm font-black text-slate-900 uppercase tracking-[0.2em] border-l-4 border-purple-600 pl-4 mb-8">Security Configuration</h3>
                ...
                <div class="space-y-6 pt-4">
                    <h3 class="text-sm font-black text-slate-900 uppercase tracking-[0.2em] border-l-4 border-amber-500 pl-4 mb-8">Visual Identity</h3>
                    
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Upload Profile Picture</label>
                        <div class="relative">
                            <input type="file" name="profile_image" accept="image/*"
                                class="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl font-bold text-slate-600 outline-none file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-[10px] file:font-black file:bg-indigo-600 file:text-white hover:file:bg-indigo-700 transition-all">
                        </div>
